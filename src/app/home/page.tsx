  ...
  const [posts, setPosts] = useState<Post[]>([
    {
      ...
      content:
        "Ada yang ambil Software Engineering semester ini? Mau diskusi requirement sama use case diagram buat project.",
      ...
      comments: [
        {
          id: 1,
          name: "jennie_kim",
          content: "Aku ambil juga, use case diagramnya lumayan tricky 😭",
          isMine: true,
          likes: 30,
        },
        {
          ...
          content: "Fokus ke actor sama include/extend dulu sih biar aman.",
          isMine: false,
          likes: 147,
        },
      ],
    },
    {
      ...
      content:
        "Selling buku Algorithm Design masih bagus banget. DM kalau minat, bisa COD kampus Anggrek.",
      tag: "#Marketplace",
      isMine: false,
      likes: 11,
      comments: [
        {
          id: 1,
          name: "sooyaa__",
          content: "Masih ada? Harganya berapa?",
          isMine: false,
          likes: 3,
        },
      ],
    },
    {
      ...
      content:
        "Reminder: deadline GSLC Machine Learning besok jam 23.59. Jangan lupa submit ZIP + report.",
      tag: "#Reminder",
      isMine: false,
      likes: 786,
      comments: [],
