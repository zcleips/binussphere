...
export default function HomePage() {
  ...
  {
    id: 1,
    name: "bitcoinanjlok6969",
    major: "Information Systems · 2025",
    content:
      "Selling buku Algorithm Design masih bagus banget. Bisa COD kampus Anggrek.",
    tag: "#MARKETPLACE #sell",
    isMine: false,
    likes: 34,
    comments: [
      {
        id: 1,
        name: "jennie_kim",
        content: "Masih available? Harganya berapa?",
        isMine: true,
        likes: 2,
      },
      {
        id: 2,
        name: "lalalisa_m",
        content: "Aku juga minat kalau belum sold.",
        isMine: false,
        likes: 0,
      },
    ],
  },
  {
    ...
    content:
      "Looking to buy secondhand keyboard mechanical yang masih bagus. Budget 300k.",
    tag: "#MARKETPLACE #buy",
    isMine: false,
    likes: 78,
    comments: [
      {
        id: 1,
        name: "sooyaa__",
        content: "Aku ada Keychron lama, nanti aku DM detailnya.",
        isMine: false,
        likes: 8,
      },
    ],
  },
  {
    ...
    content:
      "Trade buku Cybersecurity Basics dengan buku Database Systems. Meet up di Library Alam Sutera.",
...
<MenuItem icon="🛒" text="Marketplace" href="/marketplace" active />
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  className="w-full resize-none bg-slate-50 border border-slate-200 rounded-2xl p-4 outline-none focus:ring-2 focus:ring-blue-400"
                  rows={3}
                />
...
function PostCard({
  ...
  return (
    <article className="bg-white rounded-3xl shadow-sm border border-slate-200 p-5 relative">
      {reportMsg && (
          ...
          <div className="flex justify-between">
            ...
            {post.isMine ? (
              ...
              <div className="relative">
                ...
                {showReportMenu && (
                  <div className="absolute right-0 mt-2 w-44 bg-white border border-slate-200 rounded-2xl shadow-lg overflow-hidden z-20">
                    {["Abusive", "Hate speech", "Nudity", "Others"].map(
                      (reason) => (
                        <button
                          key={reason}
                          onClick={() => submitReport(reason)}
                          className="block w-full text-left px-4 py-3 text-sm hover:bg-slate-100"
                        >
                          {reason}
                        </button>
                      )
        ...
        <div className="flex gap-4 mt-1 ml-2 text-xs font-semibold text-slate-500">
          ...
          {comment.isMine ? (
            ...
            <div className="relative">
              ...
              {showReportMenu && (
                <div className="absolute left-0 mt-2 w-40 bg-white border border-slate-200 rounded-2xl shadow-lg overflow-hidden z-20">
                  {["Abusive", "Hate speech", "Nudity", "Others"].map(
                    (reason) => (
                      <button
                        key={reason}
