      ...
      <section className="max-w-7xl mx-auto grid grid-cols-[240px_1fr_320px] gap-6 px-6 py-6">
        <aside className="sticky top-24 h-fit">
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-4">
            ...
            <MenuItem icon="🔔" text="Notifications" href="/notifications" active />
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
            {notifications.map((notif) => (
              ...
              >
                ...
                >
                  {notif.type === "like" && <Heart className="w-5 h-5 fill-red-500" />}
        ...
        <aside className="sticky top-24 h-fit space-y-5">
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-5">
            <h2 className="font-extrabold text-xl">Activity Summary</h2>
            <div className="mt-4 space-y-3 text-slate-600">
              <p><span className="font-bold text-blue-500">2</span> new likes</p>
              <p><span className="font-bold text-blue-500">1</span> new reply</p>
              <p><span className="font-bold text-blue-500">1</span> new DM</p>
            </div>
          </div>
        </aside>
      </section>
